...
type VM struct {
	quads                                                                                                                                                                                                                                                                                                                                                                                           []Quad
	globalIntAddressMgr, localIntAddressMgr, tempIntAddressMgr, constIntAddressMgr, globalFloatAddressMgr, localFloatAddressMgr, tempFloatAddressMgr, constFloatAddressMgr, globalStringAddressMgr, localStringAddressMgr, tempStringAddressMgr, constStringAddressMgr, globalBoolAddressMgr, localBoolAddressMgr, tempBoolAddressMgr, constBoolAddressMgr, globalRefAddressMgr, localRefAddressMgr *AddressManager
}
...
func NewVM() VM {
	return VM{
		...
		globalFloatAddressMgr:  NewAddressManager(GLOBAL_FLOAT_START, GLOBAL_BOOL_START-1),
		globalStringAddressMgr: NewAddressManager(GLOBAL_STRING_START, GLOBAL_BOOL_START-1),
